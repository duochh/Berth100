...
RUN mkdir C:\projects\Berth100\Packaged\
COPY \v9_PixelStreaming\ C:\projects\Berth100\Packaged\
...
#docker run -it --isolation process --device class/5B45201D-F2F2-4F3B-85BB-30FF1F953599 --net devnetwork --ip 172.20.0.2 --name berth100 duochh/berth100-pixel-streaming:ltsc2022
